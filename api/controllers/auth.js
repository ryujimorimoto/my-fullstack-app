...
console.log(" GET /oauth", req);
  console.log("認証:", shopifySignature(req.apiGateway.event.queryStringParameters))
  // if(!shopifySignature(req.apiGateway.event.queryStringParameters)){
  ...
  axios.post('/',{
    ...
    let table = `${process.env.APP_NAME}ApiToken`;
    let params = {
      TableName: table,
      Item:{
        shop_id:shopOrigin,
